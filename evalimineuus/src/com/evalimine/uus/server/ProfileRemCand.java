...
public class ProfileRemCand extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		try {
			...
			c.createStatement().executeUpdate("UPDATE db.user SET db.user.ApplyState='NONE' WHERE db.user.Google_Id='"+gId+"'");
			out.write("{\"message\" : \"Olete kandidatuurist eemaldatud!\"}");
